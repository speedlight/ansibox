...
function set_settings()
	...
	nb_values=100,
	fg_bd_size=1,
	bg_colour = {{0,0x007AF6,0},{1,0xFFFFFF,0}},
	fg_bd_colour = { {0,0x668c95,1},{0.5,0x668c95,1},{1,0x668c95,1}},
	foreground=false
	},
	{
	name="downspeedf",
	...
	fg_bd_size=1,
	bg_bd_size=0,
	bg_bd_colour = { {0,0x0000ff,0},{1,0xfffff,0}},
	fg_bd_colour = { {0,0xff6c4a,0.8},{0.5,0xff6c4a,0.8},{1,0xff6c4a,0.8}},
	foreground=false,
	background=false,
	},
		{
